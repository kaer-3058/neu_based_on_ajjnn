...
execute if data storage large_number:math stemp0[1] run function neu-n_4c61:int_ascending_order/loop2
...
execute if data storage large_number:math stemp0[1] if score #temp_sorting int matches 1 run function neu-n_4c61:int_ascending_order/loop
