...
#载入被除数
scoreboard players set #float_int0 int 210000000
scoreboard players set #float_exp int 8
...
function neu-n_4c61:int_8decimal/macro1 with storage large_number:math
